...
insert into public.publications (title, type, authors, abstract, publish_date, volume) values
  ('Gender Equality in Sub-Saharan Africa: Progress and Challenges', 'journal', 'Prof. O.I. Aina, Dr. O.O. Ilesanmi', 'This paper examines the multifaceted dimensions of gender equality across Sub-Saharan Africa.', '2024-03-15', '1'),
  ('CGHDS Newsletter — Q1 2025', 'newsletter', 'CGHDS Editorial Team', 'Updates from the Centre including upcoming conferences and student achievements.', '2025-01-20', null),
  ('Humanitarian Response in Crisis-Affected Communities', 'monograph', 'Mrs. I.D. Adefisoye', 'A comprehensive monograph exploring humanitarian response frameworks.', '2023-11-10', '2');

-- Sample staff data (replace photo_url with real image URLs)
insert into public.staff (name, role, category, photo_url, tenure, achievements, sort_order) values
